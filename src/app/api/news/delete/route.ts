...
async function deleteArticles(dateFilter: string) {
...
export async function GET(req: NextRequest) {
  try {
    const dateFilter = req.nextUrl.searchParams.get("dateFilter") || "all";
    const result = await deleteArticles(dateFilter);
